          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2 border-t border-border/50">
            ...
            {experience.certificateUrl && (
              <a
                ...
                className="no-underline group inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-mono font-medium border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 hover:border-cyan-500/50 transition-all duration-200 cursor-pointer shadow-sm w-fit shrink-0"
              >
                <Award className="w-3.5 h-3.5 text-cyan-400 group-hover:scale-110 transition-transform" />
                <span>View Certificate</span>
                <ArrowUpRight className="w-3 h-3 text-cyan-400/70 group-hover:text-cyan-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </a>
            )}
          </div>
        </CardContent>
