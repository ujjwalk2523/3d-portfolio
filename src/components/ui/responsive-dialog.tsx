...
function ResponsiveDialogContent({
  ...
  return (
    <DrawerContent className={cn("max-h-[92vh] flex flex-col p-0 gap-0 overflow-hidden", className)}>
      <div className="flex-1 overflow-y-auto max-h-[88vh] w-full" data-lenis-prevent>
        {children}
      </div>
    </DrawerContent>
  );
